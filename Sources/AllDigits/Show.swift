...
@available(iOS 13.0, *)
@available(macOS 10.15, *)
public class UnicodePresentation: ObservableObject {
...
@available(iOS 13.0, *)
@available(macOS 10.15, *)
public class GraphicPresentation : ObservableObject {
...
public class LitteralPresentation: ObservableObject {

    @Published public var native : String = ""
    @Published public var parle : String = ""
    @Published public var romanise : String = ""
    @Published public var alire : String = ""
    @Published public var script : Ecriture
